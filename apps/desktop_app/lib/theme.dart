...
class SigapTheme {
  static const Color primaryColor = Color(0xFFFF1744); // Neon red for critical alarms
  static const Color secondaryColor = Color(0xFF00E5FF); // Neon cyan for active tracking
  static const Color backgroundColor = Color(0xFF0A0D14); // Very deep slate/black
  ...
  static const Color textSecondaryColor = Color(0xFF8E9EB6); // Desaturated blue-grey
