...
class _ReportDetailScreenState extends State<ReportDetailScreen> {
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<DashboardBloc, DashboardState>(
      builder: (context, state) {
        ...
        patrolWithDistance.sort((a, b) => (a['distance'] as double).compareTo(b['distance'] as double));
                      ...
                      Column(
                        ...
                        children: [
                          Row(
                            children: [
                              Text(
                                isSos ? 'SOS Voice (Zero-Click)' : 'Laporan Visual Warga',
                          ...
                          Text(
                            ...
                            style: TextStyle(fontSize: 10, color: Colors.white.withOpacity(0.4), fontFamily: 'Courier'),
                          ),
                        ],
                      ),
                    ],
                          ...
                          children: [
                            ...
                            GlassCard(
                              ...
                              child: Row(
                                children: [
                                  CircleAvatar(
                                    backgroundColor: SigapTheme.infoColor.withOpacity(0.12),
                                  ...
                                  _buildReputationGauge(reporter['reputation_score'] ?? 100.0),
                                ],
                              ),
                            ),
                            ...
                            if (isSos) ...[
                              _buildSectionTitle('REKAMAN BUKTI SUARA SOS (30 DETIK)'),
                              const SizedBox(height: 8),
                              GlassCard(
                                opacity: 0.05,
                                child: Column(
                                    ...
                                    Row(
                                      children: [
                                        IconButton(
                                          ...
                                          icon: Icon(_isPlayingAudio ? Icons.pause_rounded : Icons.play_arrow_rounded),
                                        ),
                                        const SizedBox(width: 16),
                                        Expanded(
                                          child: Column(
                                            ...
                                            children: [
                                              Slider(
                                                ...
                                                activeColor: SigapTheme.primaryColor,
                                              ...
                                              Padding(
                                                ...
                                                child: Row(
                                                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                                  children: [
                                                    Text('00:${(_audioProgress * 30).toInt().toString().padLeft(2, '0')}', style: const TextStyle(fontSize: 10)),
                                    ...
                                    Container(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          Row(
                                            children: [
                                              const Icon(Icons.translate_rounded, color: SigapTheme.secondaryColor, size: 14),
                                          ...
                                          Text(
                                            report['description'] ?? '"Tolong saya dibegal! Motor saya dirampas di Simpang Dago, pelaku membawa senjata tajam jenis parang!"',
                                          ...
                                          Container(
                                            ...
                                            child: const Text(
                                              ...
                                              style: TextStyle(fontSize: 10, color: SigapTheme.primaryColor, fontWeight: FontWeight.bold),
                                            ),
                                          ),
                                        ],
                                      ),
                              ...
                              _buildSectionTitle('FOTO BUKTI VISUAL & AI ANALYSIS'),
                              const SizedBox(height: 8),
                              GlassCard(
                                opacity: 0.05,
                                child: Column(
                                  ...
                                  children: [
                                    ClipRRect(
                                      borderRadius: BorderRadius.circular(10),
                                      child: Image.network(
                                        report['image_url'] ?? 'https://images.unsplash.com/photo-1614064641938-3bbee52942c7?auto=format&fit=crop&w=600&q=80',
                                        height: 240,
                                        fit: BoxFit.cover,
                                    ...
                                    Container(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          Row(
                                            children: [
                                              const Icon(Icons.analytics_outlined, color: SigapTheme.secondaryColor, size: 14),
                                              const SizedBox(width: 6),
                                              Text(
                                          ...
                                          Text(
                                            report['description'] ?? 'Dua orang mencurigakan berboncengan di trotoar, salah satu pelaku membawa logam panjang berkilau menyerupai golok.',
                            ...
                            _buildSectionTitle('AI ANTI-SPOOFING FILTER INTEGRITAS'),
                            const SizedBox(height: 8),
                            GlassCard(
                              opacity: 0.05,
                              child: Column(
                                children: [
                                  ...
                                  _buildVerificationRow(
                                    label: 'Deteksi Rekayasa AI Generatif (Pixel Analysis)',
                                    success: !isSpoofed,
                                    score: antiSpoofScore,
                                  ),
                                  const Divider(height: 16, color: Colors.white10),
                                  _buildVerificationRow(
                                    label: 'Deteksi Duplikasi Gambar Internet (Reverse Lookup)',
                                    success: !isSpoofed,
                                    score: 1.0,
                                  ),
                                ],
                    ...
                    Expanded(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          _buildSectionTitle('PENGIRIMAN UNIT PATROLI TERDEKAT'),
                          const SizedBox(height: 8),
                          GlassCard(
                            opacity: 0.05,
                            child: Column(
                              ...
                              children: [
                                if (assignedUnit != null) ...[
                                  Container(
                                    ...
                                    decoration: BoxDecoration(
                                      color: SigapTheme.successColor.withOpacity(0.12),
                                      borderRadius: BorderRadius.circular(8),
                                      border: Border.all(color: SigapTheme.successColor.withOpacity(0.3)),
                                    ),
                                    child: Row(
                                      children: [
                                        const Icon(Icons.check_circle_outline_rounded, color: SigapTheme.successColor, size: 20),
                                        const SizedBox(width: 12),
                                        Expanded(
                                          child: Column(
                                            crossAxisAlignment: CrossAxisAlignment.start,
                                            children: [
                                              const Text(
                                                ...
                                                style: TextStyle(fontWeight: FontWeight.bold, fontSize: 11, color: SigapTheme.successColor, letterSpacing: 0.5),
                                              ),
                                              const SizedBox(height: 2),
                                              Text(
                                                assignedUnit['name'],
                                  ...
                                  DropdownButtonFormField<String>(
                                    ...
                                    decoration: InputDecoration(
                                      ...
                                      labelStyle: TextStyle(fontSize: 10, color: Colors.white.withOpacity(0.5), fontWeight: FontWeight.bold),
                                      filled: true,
                                        ...
                                        : () {
                                            context.read<DashboardBloc>().add(
                                              AssignPatrolUnitEvent(
                                                reportId: report['id'],
                                                patrolUnitId: _selectedPatrolUnitId!,
                                              ),
                                            );
                                            ScaffoldMessenger.of(context).showSnackBar(
                                              const SnackBar(
                                                content: Text('Unit patroli berhasil ditugaskan ke lokasi kejadian'),
                                                backgroundColor: SigapTheme.successColor,
                                              ),
                                            );
                                          },
  ...
  Widget _buildVerificationRow({required String label, required bool success, required double score}) {
    return Row(
      mainAxisAlignment: MainAxisAlignment.spaceBetween,
      children: [
        Text(
        ...
        Row(
          children: [
            Icon(
              ...
              color: success ? SigapTheme.successColor : SigapTheme.primaryColor,
              size: 16,
            ),
            const SizedBox(width: 8),
            Text(
